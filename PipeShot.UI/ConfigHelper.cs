...
namespace PipeShot.UI {
    public static class ConfigHelper {
        ...
        public static AfterSnipe AfterSnipeAction {
            get => JsonConfig.AfterSnipeAction;
            set {
                Settings settings = JsonConfig;
                settings.AfterSnipeAction = value;
                JsonConfig = settings;
            }
        }
        ...
        //Value wether run PipeShot as a Background Task on Boot or not
        ...
        //Count of Commits for this PipeShot Version (for checking for Updates)
        ...
        public static string ConfigFile
            => Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "PipeShot", "config.json");

        public static string InstallDir => AppDomain.CurrentDomain.BaseDirectory;

        //Salt for Cipher Encryption
        private static string PassPhrase => "PipeShot User-Login File_PassPhrase :)";
