...
namespace PipeShot.Libraries.Helper {
    public class ImgurUploader {
        ...
        public async Task<string> Upload(Stream stream, string windowName = null) {
            ...
            IImage image = await endpoint.UploadImageStreamAsync(stream, null, null, "https://github.com/piperift/PipeShot");
            return image.Link;
        }
        ...
        public async Task<Tuple<string, string>> CreateAlbum() {
            ...
            IAlbum album = await endpoint.CreateAlbumAsync("Images uploaded with PipeShot",
				"https://github.com/piperift/PipeShot");
