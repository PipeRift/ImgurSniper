    ...
    public static class Helpers {
        ...
        public static void WriteError(Exception ex) {
            try {
                ...
                string errorDetails = $"!PipeShot Error @{DateTime.Now}" + nl +
                ...
                if (File.Exists(errorFile)) {
                    ...
                    File.WriteAllText(errorFile,
                        $"Details for an Exception in PipeShot. " +
                        "You can tell me about this error on http://www.github.com/piperift/Pipeshot/issues so I can fix it as soon as possible!"
                        + nl + errorDetails);
                }
            } catch { }
        }
