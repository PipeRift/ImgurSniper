...
namespace FFmpegManager {
    internal static class FFmpegHelper {
        ...
        internal static string FFmpegDirectory = Path.Combine(Documents, "PipeShot");
        internal static string FFmpegPath = Path.Combine(FFmpegDirectory, "ffmpeg.exe");
        internal const string FFmpegUrl = "https://ffmpeg.zeranoe.com/builds/win64/static/ffmpeg-20180606-e4006a4-win64-static.zip";
